  ...
  return (
    <div className={styles.homeContainer}>
      ...
      <div className={styles.homeSideContents}>
        ...
        <Panel pageName="Informações do Usuário" section="Gestão de Professor" color="#F66B0E" />
          ...
          <div className={styles.homeInfoTop}>
            <div className={styles.homeProfileTeacher}>
              ...
              <form className={styles.basicinfo}>
                ...
                <input type="text" name="matricula" placeholder="123456" className={styles.inpMat} disabled />
                ...
                <input type="text" placeholder="50%" className={styles.inpFre} disabled />
              ...
              <form className={styles.geral}>
                ...
                <textarea
                  ...
                  rows="2"
                  cols="50"
                  placeholder="DSM 3 - Gestão Ágil de Projetos de Software, Banco de Dados não Relacional, Interação Humano Computador, Técnica de Programação II, Inglês I, Desenvolvimento Web III, Álgebra Linear"
                ></textarea>
